...
namespace SuperMobs.AssetManager.Core
{
	...
	public class ByteReader
	{
		...
		public ByteReader(byte[] bytes, char separator) { mBuffer = bytes; separatorChar = separator; }
		...
		bool canRead { get { return (mBuffer != null && mOffset < mBuffer.Length); } }
		...
		string ReadLine() { return ReadLine(true); }
