	...
	public sealed class Crc32
	{
		...
		public static uint GetFileCRC32(string path)
		{
			if (string.IsNullOrEmpty(path))
				throw new ArgumentNullException("GetFileCRC32 path:" + path);
			else if (!File.Exists(path))
			{
				UnityEngine.Debug.LogError("GetFileCRC32 file not exist: " + path);
				return 0;
			}
		...
		public static uint GetStringCRC32(string content)
		{
			if (string.IsNullOrEmpty(content))
				throw new ArgumentNullException("GetStringCRC32 content is Null");
		...
		public static uint GetBytesCRC32(byte[] content)
		{
			if (content == null)
				throw new ArgumentNullException("GetBytesCRC32 content is Null");
